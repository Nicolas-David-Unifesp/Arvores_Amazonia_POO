...
class MutableFlyweight implements flyweight {
    ...
    public void setActual_height_tree(String actual_height_tree, String diameter_at_breast_height) {
...
class FlyweightFactory {
    ...
    public flyweight getFlyweight(String key) {
        if (!flyweights.containsKey(key)) {
            ...
            flyweights.put(key, new ConcreteFlyweight(attributes[0], attributes[1], attributes[2]));
        }
